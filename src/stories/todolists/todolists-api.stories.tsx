...
export const CreateTodolist = () => {
	...
	return <div> {JSON.stringify(state)}
		<div>
			<input placeholder={'new title'} type="text" value={newTitleTodolist} onChange={(e) => {
...
export const DeleteTodolist = () => {
	...
	return <div> {JSON.stringify(state)}
		<div>
			<input placeholder={'todolistId'} type="text" value={deleteTodolist} onChange={(e) => {
				setDeleteTodolist(e.currentTarget.value)
			}}/>
